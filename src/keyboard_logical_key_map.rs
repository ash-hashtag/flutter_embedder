...
pub fn translate_logical_key(key: Key) -> Option<u64> {
    Some(match key {
        ...
        Key::Named(key) => match key {
            ...
            // NamedKey::ShiftLevel5 => 0x00100000111,
            ...
            // NamedKey::Soft5 => 0x00100000905,
            // NamedKey::Soft6 => 0x00100000906,
            // NamedKey::Soft7 => 0x00100000907,
            // NamedKey::Soft8 => 0x00100000908,
            ...
            // NamedKey::LaunchAssistant => 0x00100000b0e,
            // NamedKey::LaunchControlPanel => 0x00100000b0f,
            ...
            // NamedKey::Standby => 0x00200000000,
            // NamedKey::WakeUp => 0x00200000001,
            // NamedKey::Sleep => 0x00200000002,
            // NamedKey::Abort => 0x00200000003,
            // NamedKey::Lang1 => 0x00200000010,
            // NamedKey::Lang2 => 0x00200000011,
            // NamedKey::Lang3 => 0x00200000012,
            // NamedKey::Lang4 => 0x00200000013,
            // NamedKey::Lang5 => 0x00200000014,
